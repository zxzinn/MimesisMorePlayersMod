...
[assembly: MelonInfo(typeof(MorePlayers.MorePlayersMod), "MorePlayers", "1.0.8", "github.com/zxzinn")]
...
namespace MorePlayers
{
    public class MorePlayersMod : MelonMod
    {
        ...
        {
            MelonLogger.Msg("=================================================");
            MelonLogger.Msg("MorePlayers Mod v1.0.8 - Complete Edition");
            MelonLogger.Msg("=================================================");
            MelonLogger.Msg("Author: github.com/zxzinn (based on Rxflex's work)");
            MelonLogger.Msg($"Max Players: {MAX_PLAYERS}");
            MelonLogger.Msg("");
            MelonLogger.Msg("Applying all 11 patches from original mod...");
    ...
    public class InGameMenu_SetPingImage_Patch
    {
        ...
        static Exception Finalizer(Exception __exception)
        {
            ...
            {
                // Suppress array index out of bounds errors
                return null;
            }
            return __exception;
        }
